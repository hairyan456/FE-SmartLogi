                ...
                <div className='login-background'>
                    <div className='login-container'>
                        <div className='login-content row'>
                            ...
                            <div className='col-12 bellow-login'>
                                <span className='forgot-password'>
                                    <Link to='/home'><i style={{ marginRight: '5px' }} class="fas fa-backward"></i> Return to homepage</Link>
                                </span>
                                <span className='register'>
                                    <Link to='/register'>Register <i style={{ marginLeft: '5px' }} class="fas fa-forward"></i></Link>
                                </span>
                            </div>
